    ...
    exports.createDriverExperience = async (req, res) => {
      try {
        const { driverId , companyName, jobTitle, vehicletype, starttime, endtime, status } = req.body;
        ...
        res.status(500).json({ error: 'An error occurred while creating the driver experience' });
      }
    };
    ...
    exports.getAllDriverExperiences = async (req, res) => {
      try {
        const driverExperiences = await DriverExperience.find().populate(['vehicletype']).populate(['driverId'])
        res.json(driverExperiences);
      } catch (error) {
        console.error('Error fetching driver experiences:', error);
        res.status(500).json({ error: 'An error occurred while fetching the driver experiences' });
      }
    };
    ...
    exports.getDriverExperienceById = async (req, res) => {
      try {
        const driverExperience = await DriverExperience.findById(req.params.id).populate(['vehicletype']).populate(['driverId'])
        ...
        res.status(500).json({ error: 'An error occurred while fetching the driver experience' });
      }
    };
    ...
    exports.updateDriverExperience = async (req, res) => {
      try {
        ...
        res.status(500).json({ error: 'An error occurred while updating the driver experience' });
      }
    };
    ...
    exports.deleteDriverExperience = async (req, res) => {
      try {
        const deletedDriverExperience = await DriverExperience.findByIdAndRemove(req.params.id);
        ...
        res.status(500).json({ error: 'An error occurred while deleting the driver experience' });
      }
    };
